              ...
              children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(widget.hotelImagePath),
                          fit: BoxFit.cover,
                        ),
                      ),
                      child: Column(
                ...
                Text(
                  isReadMore
                      ...
                      : widget.hotelDescription.length > 100
                      ? widget.hotelDescription.substring(0, 100) + '...'
                      : widget.hotelDescription,
                  style: TextStyle(
                    fontWeight: FontWeight.w500,
                    fontSize: 15,
                ...
                if (widget.hotelDescription.length > 100)
                  TextButton(
                    onPressed: () {
                      setState(() {
